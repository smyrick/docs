...
See other common post https://productionreadygraphql.com/2020-08-01-guide-to-graphql-errors

Most common patterns

* Top-Level Errors
* Error Fields in schema

Past this we start using the Errors as data approach (link to TN)
* Error Type and Array
* Error Interface
* Result Types aka Unions
* Error Result Type List
* Error Union List + Interface
